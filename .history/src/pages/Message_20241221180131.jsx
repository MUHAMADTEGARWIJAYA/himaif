  ...
  return (
    <div className="flex justify-center mt-44">
      <div className="w-full max-w-7xl items-center h-72 bg-blue-500 rounded-lg p-10">
        ...
        <div className="bg-black flex max-w-5xl">
          <div className="flex flex-col justify-between max-w-4xl bg-white rounded-lg shadow-lg">
            {/* Text Section */}
            <div className="flex items-center gap-4 p-4">
              <input
                type="text"
                placeholder="Masukan Saranmu"
                className="flex-grow px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 w-full"  // Menggunakan w-full untuk memperpanjang input
              />
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <button className="font-inherit text-[18px] bg-gradient-to-b from-[#4dc7d9] to-[#66a6ff] text-white py-[0.8em] px-[2em] border-none rounded-[25px] shadow-[0px_5px_10px_rgba(0,0,0,0.2)] transition-all duration-300 hover:translate-y-[-3px] hover:shadow-[0px_8px_15px_rgba(0,0,0,0.3)] hover:py-0 hover:bg-gradient-to-b hover:from-[#5bd9ec] hover:to-[#97c3ff] active:scale-95 active:shadow-[0px_2px_5px_rgba(0,0,0,0.2)]">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                />
                <span className="text-[18px]">Send</span>
              </div>
            </button>
          </div>
        </div>
