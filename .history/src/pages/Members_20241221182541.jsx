...
const About = () => {
    return (
      <div className="flex flex-col h-96 items-center bg-black mt-10">
        <h3 className="text-center font-semibold text-xl">ABOUT US</h3>
          ...
          <br />
          <p className="text-center max-w-4xl">Logo ini mencerminkan semangat kolektif dari mahasiswa informatika yang bersatu dalam 
